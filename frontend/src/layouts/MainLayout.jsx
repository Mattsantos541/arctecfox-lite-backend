  ...
  <NavLink
    ...
    className={({ isActive }) =>
      `flex items-center gap-3 p-3 rounded-lg transition ${
        isActive ? "bg-[#007BFF] text-white font-semibold" : "hover:bg-[#00C2FF]"
      }`
    }
  >
...
const TopBar = () => {
  return (
    <header className="fixed top-0 left-64 right-0 h-16 bg-white shadow-sm flex items-center justify-between px-6 border-b z-10">
      {/* Centered Title */}
      <div className="text-gray-800 font-bold text-xl flex-1 text-center">ArcTecFox PM</div>

      {/* User Info & Logout */}
      <div className="flex items-center space-x-4">
        <span className="text-gray-600">Welcome, User</span>
        <button className="flex items-center gap-2 text-gray-600 hover:text-[#007BFF]">
